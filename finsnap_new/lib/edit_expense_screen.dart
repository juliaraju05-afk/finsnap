...
class _EditExpenseScreenState extends State<EditExpenseScreen> {
  ...
  void initState() {
    ...
    _amountCtrl = TextEditingController(text: (widget.expense['amount'] as double).toStringAsFixed(2));
    _noteCtrl   = TextEditingController(text: widget.expense['note'] ?? "");
    _type       = widget.expense['type'] ?? "debit";
    _category   = widget.expense['category'] ?? "Others";
    try { _date = DateTime.parse(widget.expense['date']); } catch (_) { _date = DateTime.now(); }
  }
  ...
  Widget build(BuildContext context) {
    List cats = _cats;
    if (!cats.any((c) => c['name'] == _category)) _category = "Others";
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Edit Transaction", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 18)),
        centerTitle: true,
        actions: [TextButton(onPressed: _submit,
          child: Text("Save", style: TextStyle(color: AppColors.gold, fontWeight: FontWeight.w700, fontSize: 15)))],
      ),
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(height: 24),
          _SectionLabel("Amount"), SizedBox(height: 8),
          Container(
            decoration: BoxDecoration(color: AppColors.navyCard, borderRadius: BorderRadius.circular(14),
              border: Border.all(color: AppColors.divider)),
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: "0.00", hintStyle: TextStyle(color: AppColors.grey, fontSize: 24),
          ...
          _DarkTextField(controller: _titleCtrl, hint: "Transaction title", icon: Icons.edit_rounded),
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    SizedBox(height: 6),
                    Text(cat['name'] as String, style: TextStyle(color: sel ? c : AppColors.grey,
          ...
          SizedBox(width: double.infinity, height: 54,
            child: ElevatedButton(
              ...
              onPressed: _submit,
              child: Text("Update Transaction", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
            ),
          ),
          SizedBox(height: 20),
        ]),
...
class _DarkTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    decoration: BoxDecoration(color: AppColors.navyCard, borderRadius: BorderRadius.circular(14),
      border: Border.all(color: AppColors.divider)),
    child: TextField(controller: controller, style: TextStyle(color: Colors.white, fontSize: 15),
